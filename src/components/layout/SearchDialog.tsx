...
export function SearchDialog() {
  ...
  const showResults = open && (loading || query.trim().length > 0);
  ...
  return (
    <div className="platform-search-container">
      {!open ? (
        ...
        <div className="platform-search-expanded">
          <div className="platform-search-input-row">
            ...
            />
            <button type="button" onClick={close} className="platform-search-close" aria-label="关闭搜索">
              <X size={16} aria-hidden="true" />
            </button>
          </div>

          <div className={`platform-search-results-wrapper${showResults ? " open" : ""}`}>
