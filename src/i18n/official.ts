...
const zh = {
  ...
  payment: {
    ...
    failed: "支付失败",
    autoMode: "已按当前设备自动选择支付模式",
    receiptTitle: "支付回执",
    receiptSaved: "付款已确认，交付信息已保存",
    receiptOrder: "订单号",
    receiptAmount: "实付金额",
    cardNumber: "卡号",
    cardSecret: "卡密",
    ...
    receiptFailed: "支付已确认，但回执读取失败，请前往个人中心查看",
    keepReceipt: "卡密同时保存在个人中心，请妥善保管。",
    cardDelivering: "卡密正在发放，请稍后在个人中心刷新查看。",
    membershipDelivered: "会员已自动开通，无需卡密。",
    articleDelivered: "付费文章已解锁。",
    continue: "继续查看内容",
    result: {
      deliveryPending: "支付已确认，正在发放卡密，请勿关闭页面…",
      confirmingProvider: "正在向支付平台确认结果，异步通知延迟时会自动查单…",
      delayed: "若已扣款但状态未更新，请稍后刷新或联系管理员核对订单。",
      confirming: "正在确认支付结果",
      success: "支付成功",
      redirecting: "订单与交付信息已保存到个人中心。",
      viewOrders: "查看我的订单",
      processing: "支付处理中",
  ...
  account: {
    eyebrow: "会员中心",
    title: "账户与权益",
    description: "查看会员状态、兑换卡密、浏览订单与已购权益。",
    activeMember: "会员有效",
    inactiveMember: "尚未开通会员",
    expiresOn: "到期 {date}",
    memberPrompt: "购买会员或兑换卡密即可开通",
    loading: "正在加载账户信息…",
    account: "账户",
    membership: "会员等级",
    notActivated: "未开通",
    noExpiry: "暂无到期时间",
    articleCredits: "文章券额度",
    articleCreditsHint: "阅读付费文章时可用于解锁",
    unlockedPosts: "已解锁文章",
    orderCount: "共 {count} 笔订单",
    redeem: "卡密兑换",
    redeemMeta: "本站权益 / 外部卡密",
    cardNumber: "卡号",
    cardSecret: "卡密",
    redeemNow: "立即兑换",
    redeeming: "兑换中…",
    redeemed: "卡密兑换成功",
    redeemHint: "本站 VIP、文章券、余额卡密会写入账户权益；外部或通用卡密仅完成核销并显示兑换说明，不会自动解锁本站文章。",
    balance: "账户余额",
    balanceHint: "余额卡密兑换后会自动入账；余额支付功能将在开放后显示在此处。",
    buyMembership: "查看会员与支持方式",
    orderHistory: "订单历史",
    recentOrders: "最近订单",
    continuePayment: "继续支付",
    paidNotice: "支付成功，可在下方订单中查看交付与权益信息。",
    loadingOrders: "正在加载订单…",
    loadOrdersFailed: "加载订单失败",
    retry: "重试",
    emptyOrders: "暂无订单，前往支持页选择会员或卡密商品。",
    orderNumber: "订单号",
    product: "商品",
    amount: "金额",
    status: "状态",
    ...
    none: "—",
    fulfillment: "权益说明",
    membershipBenefit: "会员订阅：支付成功后自动延长 VIP 有效期，可阅读全部会员文章。",
    creditBenefit: "文章券：仅适用于本站付费文章，当前还有 {count} 篇待使用额度。",
    externalCardBenefit: "外部或通用卡密：兑换成功不代表解锁本站内容。",
    unlockedBenefit: "已解锁 {count} 篇付费文章，注册于 {date}。",
    orderStatus: {
      PENDING: "待支付",
      PAID: "已支付",
      CANCELLED: "已取消",
...
const en = {
  ...
  payment: {
    ...
    qrFailed: "Unable to generate the QR code. Start the payment again.",
    ...
    autoMode: "Payment mode selected automatically for this device",
    receiptTitle: "Payment receipt",
    receiptSaved: "Payment confirmed and delivery saved",
    receiptOrder: "Order number",
    ...
    receiptFailed: "Payment is confirmed, but the receipt could not be loaded. Check your account center.",
    keepReceipt: "This card key is also saved in your account center. Keep it secure.",
    cardDelivering: "Your card key is being delivered. Refresh the account center shortly.",
    membershipDelivered: "Your membership is active. No card key is required.",
    articleDelivered: "The paid article is now unlocked.",
    continue: "Continue to content",
    result: {
      deliveryPending: "Payment confirmed. Your card key is being delivered; keep this page open…",
      confirmingProvider: "Confirming the result with the payment provider…",
      delayed: "If you were charged but the status has not updated, refresh later or contact support.",
      confirming: "Confirming payment",
      success: "Payment successful",
      redirecting: "The order and delivery details are saved in your account center.",
  ...
  account: {
    ...
    description: "Review membership status, redeem card keys, and keep orders and purchased access in one place.",
    activeMember: "Membership active",
    inactiveMember: "No active membership",
    expiresOn: "Expires {date}",
    memberPrompt: "Choose a membership or redeem a card key to get started",
    ...
    articleCreditsHint: "Use these credits to unlock paid articles",
    unlockedPosts: "Unlocked articles",
    orderCount: "{count} orders total",
    redeem: "Redeem a card key",
    redeemMeta: "Site benefits / external card keys",
    cardNumber: "Card number",
    cardSecret: "Card secret",
    redeemNow: "Redeem now",
    redeeming: "Redeeming…",
    redeemed: "Card key redeemed",
    redeemHint: "Site VIP, article-credit, and balance cards add benefits to this account. External or general card keys are only verified and do not unlock site articles automatically.",
    balance: "Account balance",
    balanceHint: "Balance cards are added to your account after redemption. Balance checkout will appear here when it becomes available.",
    buyMembership: "View membership & support",
    orderHistory: "Order history",
    recentOrders: "Recent orders",
    continuePayment: "Continue payment",
    paidNotice: "Payment completed. Review delivery and access details in the orders below.",
    loadingOrders: "Loading orders…",
    loadOrdersFailed: "Unable to load orders",
    retry: "Try again",
    emptyOrders: "No orders yet. Visit support to choose a membership or card-key product.",
    orderNumber: "Order",
    product: "Product",
    amount: "Amount",
    status: "Status",
    ...
    none: "—",
    fulfillment: "Access details",
    membershipBenefit: "Membership: payment automatically extends VIP access and unlocks all member articles.",
    creditBenefit: "Article credits: these apply to site paid articles. {count} credits remain to use.",
    externalCardBenefit: "External or general card keys: successful redemption does not unlock site content.",
    unlockedBenefit: "{count} paid articles unlocked. Account created {date}.",
    orderStatus: {
    ...
    productTypes: {
      VIP_MONTH: "Monthly membership",
      VIP_QUARTER: "Quarterly membership",
      VIP_YEAR: "Annual membership",
      PAID_POST: "Paid article",
      CARD_PACKAGE: "Card-key package",
    },
  },
} as const;
