...
const zh = {
  ...
  home: {
    ...
    hero: {
      ...
      primaryAction: { label: "购买卡密", href: "/pricing" },
      secondaryAction: { label: "获取下载方式", href: "/download" },
    },
    latestPrefix: "已适配",
  ...
  pages: {
    ...
    download: {
      ...
      description: "工具本身免费。请认准 cloudmantoua.top 官方网站，并根据设备系统选择页面提供的真实安装方式。",
      ...
      packageTitle: "获取安装包",
      packageUnavailable: "本页当前还没有配置馒头助手安装包的公开下载地址，因此暂不展示占位按钮。正式入口配置完成后才会在本站显示；请勿使用来源不明的安装包或向第三方支付所谓激活费用。",
...
const en = {
  ...
  home: {
    ...
    hero: {
      ...
      primaryAction: { label: "Buy a card key", href: "/pricing" },
      secondaryAction: { label: "Get download options", href: "/download" },
    },
  ...
  pages: {
    ...
    download: {
      ...
      description: "The toolkit is free. Use cloudmantoua.top and choose only the official installation options shown for your device.",
      ...
      packageUnavailable: "A public installer URL has not been configured, so this page does not show a placeholder download. The official link will appear only after it is ready. Do not use untrusted installers or pay third parties for supposed activation.",
